  ...
  <form action="./delete.php" method="POST">
    <table>
      ...
      <?php foreach($trainings as $training):?>
        ...
        $Trainingsbeginndate = $training['Trainingsbeginn']->format('Y-m-d');
        $Trainingsbeginntime = $training['Trainingsbeginn']->format('H:i:s');

        $Trainingsendedate = $training['Trainingsende']->format('Y-m-d');
        $Trainingsendetime = $training['Trainingsende']->format('H:i:s');
        ...
        <tr>
          ...
          <td>
            <input type="date" name="Trainingsbeginn[]" value="<?php echo $training[?>">
          </td>
        </tr>
      <?php endforeach;?>
    </table>
