    ...
    <table>
      ...
      <?php foreach($trainings as $training):?>
        ...
        for($i = 0; $i < count($trainers); $i++) {
          echo "trainingTrainerFK:" . $trainingTrainerFK . "Current Iter: " . $i . 'Currnet Trainer:' . $trainers[$i]["PK_Trainer"] . "Boolean:". $trainers[$i]["PK_Trainer"] == $trainingTrainerFK ."<br>";
          if($trainers[$i]["PK_Trainer"] == $trainingTrainerFK) {
            $trainingTrainer = $i;
            echo $trainingTrainer;
          }
        }
