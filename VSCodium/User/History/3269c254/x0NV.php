    ...
    <table>
      ...
      <?php foreach($trainings as $training):?>
        ...
        for($i = 0; $i < count($trainers); $i++) {
          if($trainers[$i]["PK_Trainer"] == $trainingTrainerFK) {
            $trainingTrainer = $i;
          }
        }
        ...
        <tr>
          <td>
            <input type="text" name="FK_Trainer_Nachname[]" value="<?php echo $trainers[$trainingTrainer]['Nachname']?>">
            <input type="text" name="FK_Trainer_Vorname[]" value="<?php echo $trainers[$trainingTrainer]['Vorname']?>">
          </td>
          <td>
            <input type="text" name="Team[]" value="<?php echo $teams[$playersTeam]['Teamname'] ?>">
          </td>
          ...
          <td>
            <button type="submit" name="deleteTraining" value="<?php echo $trainer['PK_Trainer'] . ';'. $teams[$playersTeam]['Teamname']  . ';' . $training['Trainingsbeginn']?>">Löschen</button>
          </td>
        </tr>
      <?php endforeach;?>
    </table>
