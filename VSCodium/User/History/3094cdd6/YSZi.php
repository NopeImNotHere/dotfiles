...
try {
  ...
  if(isset($_POST['deleteTeam'])) {
    echo "Test1";
    $teamnameToRetrieve = 'DUMMY';

    echo "Test2";
    $dummy = $conn->prepare('SELECT PK_Team FROM Team WHERE Teamname=:teamname');
    $dummy->bindParam(':teamname', $teamnameToRetrieve);
    $dummy->execute();
    echo "Test3";
    ...
    if ($team) {
        ...
        echo "Team with Teamname '$teamnameToRetrieve' not found.";
    }
