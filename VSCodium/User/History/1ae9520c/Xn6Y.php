...
<ul>
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="./add-tainer-team.php">Training zuweisen</a>
    </div>
  </li>
</ul>
...
<form action="./create.php" method="POST">
    ...
    <label for="Trainingsbeginn">Trainingsbeginn</label>
    <input type="datetime" name="Trainingsbeginn" id="Trainingsbeginn">

    <label for="Trainingsende">Trainingsende</label>
    <input type="datetime" name="Trainingsende" id="Trainingsende">
    </div>
